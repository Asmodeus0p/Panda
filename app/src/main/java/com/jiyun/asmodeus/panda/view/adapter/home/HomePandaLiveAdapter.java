...
public class HomePandaLiveAdapter extends RecyclerView.Adapter<HomePandaLiveAdapter.Holder> implements View.OnClickListener {

    private ArrayList<HomeBean.DataBean.PandaliveBean.ListBean> mList;

    public HomePandaLiveAdapter(ArrayList<HomeBean.DataBean.PandaliveBean.ListBean> mList) {
        this.mList = mList;
    }
