...
public class HomeChinaLiveAdapter extends RecyclerView.Adapter<HomeChinaLiveAdapter.Holder> implements View.OnClickListener {

    private ArrayList<HomeBean.DataBean.ChinaliveBean.ListBean> mList;

    public HomeChinaLiveAdapter(ArrayList<HomeBean.DataBean.ChinaliveBean.ListBean> mList) {
        this.mList = mList;
    }
